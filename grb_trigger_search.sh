...
########################################################################################################################
## e.g. ./grb.sh GRB180204A 2018-02-04 02:36:16 330.118 +30.846
########################################################################################################################
...
then
	...
	echo "`echo -e ' \t'`" >>$grblogs
    	 ...
    	 ~/czti_svn/trunk/users/priyanka/Veto_new.py $mkffile $products/$GRBVeto --tmark $tmark --tmin `echo "$tmark-150"|bc -l`  --tmax `echo "$tmark+150"|bc -l` #$GRBNAME  
